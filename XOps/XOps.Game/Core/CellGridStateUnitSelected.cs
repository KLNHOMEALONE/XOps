...
namespace XOps.Core
{
    public class CellGridStateUnitSelected : CellGridState
    {
        ...
        private readonly List<Unit> _unitsInRange;
        ...
        public override void OnCellDeselected(Cell cell)
        {
            ...
            foreach (var cellInRange in _pathsInRange)
            {
                cellInRange.MarkAsReachable();
            }
            foreach (var cellNotInRange in _cellGrid.Cells.Except(_pathsInRange))
            {
                cellNotInRange.UnMark();
            }
        }
