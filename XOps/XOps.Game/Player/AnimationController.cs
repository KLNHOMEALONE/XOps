...
namespace XOps.Player
{
    public class AnimationController : SyncScript, IBlendTreeBuilder
    {
        ...
        // Internal state
        private readonly EventReceiver<float> runSpeedEvent = new EventReceiver<float>(Unit.RunSpeedEventKey);
        private AnimationState state = AnimationState.Walking;

        private readonly EventReceiver<bool> attackEvent = new EventReceiver<bool>(Unit.IsAttackingEventKey);
